...
> [!NOTE]
> This is the experimental rust branch, the goal is to rewrite Mixtapes fully in Rust. Python code also remains there for my convenience until fully functional,
> the actual Rust code is in `rust/`
> It lacks many features as of now and is not properly documented in this README.md yet
